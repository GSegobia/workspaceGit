...
public class QueryAnswer1 extends JFrame {
	...
	public QueryAnswer1(String parametro) throws IOException {
		Querys.query1(parametro);
		
		Scanner fileIn = new Scanner(new File(endereco + "query1.txt"));
		int count = 0;
		...
		fileIn.close();
		fileIn=null;
		fileIn = new Scanner(new File(endereco + "query1.txt"));
		...
		table.getColumnModel().getColumn(1).setHeaderValue("Matricula");
